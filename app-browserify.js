...
var frame = function frame(_src) {
    ...
    return {
        ...
        view: function view() {
            return _mithrilResolver.m('iframe', { src: src() });
        }
    };
};
...
var home = {
    controller: function controller() {},
    view: function view() {
        return _mithrilResolver.m('.home', [_mithrilResolver.m('.hr', 'This talk is called'), _mithrilResolver.m('h1', 'Natural Physics Simulations', _mithrilResolver.m('br'), 'and Canvas Hackery'), _mithrilResolver.m('.hr', 'With this guy'), _mithrilResolver.m('img', { src: './images/me.gif' }), _mithrilResolver.m('.hr', [_mithrilResolver.m('a', { href: 'http://mkeas.org/talks' }, 'mkeas.org/talks'), ' • ', _mithrilResolver.m('a', { href: 'http://twitter.com/matthiasak' }, '@matthiasak')])]);
    }
};

var warning = function warning() {
    return _mithrilResolver.m('.warning', _mithrilResolver.m('h1.zap', { 'data-text': 'Warning' }, 'Warning'), _mithrilResolver.m('hr'), _mithrilResolver.m('h2.zap', { 'data-text': 'An old friend - math - approaches.' }, 'An old friend - math - approaches.'));
};

var recap = function recap(bullets) {
    var title = arguments.length <= 1 || arguments[1] === undefined ? 'Let\s Recap' : arguments[1];
    return _mithrilResolver.m('div', _mithrilResolver.m('.hr', title), _mithrilResolver.m('ul', bullets.map(function (bullet) {
        return _mithrilResolver.m('li', bullet);
    })));
};
...
var refs = function refs() {
    return _mithrilResolver.m('.home', _mithrilResolver.m('h2', 'References & Resources'), _mithrilResolver.m('hr'), _mithrilResolver.m('ul', links.map(function (href) {
        return _mithrilResolver.m('li', _mithrilResolver.m('a', { href: href }, href));
    })));
};

var pause1 = [[_mithrilResolver.m('code', 'particle()'), ' -> Just a function that returns an object'], [_mithrilResolver.m('code', 'particle()'), ' --> Simple data: ', _mithrilResolver.m('code', '{accel, velocity, position}')], [_mithrilResolver.m('code', 'particle()'), ' ---> Could easily hold other data (color?, weight?)'], [_mithrilResolver.m('code', 'update()'), ' ----> force → accel → velocity → position']];

var orderOfOps = ['force', 'accel & friction', 'velocity', 'position'];

var img = function img(url, title) {
    var style = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];
    return _mithrilResolver.m('div', title && _mithrilResolver.m('.hr', title), _mithrilResolver.m('img', { src: url, style: style }));
};

var movement = function movement() {
    return _mithrilResolver.m('div', _mithrilResolver.m('.hr', 'Need to move things?'), _mithrilResolver.m('pre', 'const applyForce = (mass,accel) => accel += mass*mag(accel)'));
};
...
var app = function app() {
    var e = _mithrilSlideEngine2['default']();
...
},{"./mithril-slide-engine":2,"babel/polyfill":191,"mithril-resolver":193}],2:[function(require,module,exports){
'use strict';
...
exports['default'] = function () {
    ...
    var remove = computable(function (index) {
        ...
        return slides([].concat(first, second));
    });
    ...
    var arrows = function arrows() {
        return [_mithrilResolver.m('.arrow.left', { onclick: function onclick() {
                return navigate(active() - 1);
            } }), _mithrilResolver.m('.arrow.right', { onclick: function onclick() {
                return navigate(active() + 1);
            } })];
    };
    ...
    var view = function view(ctrl) {
        ...
        var _slide = _mithrilResolver.m('div', { key: a, className: sel }, s[a]);

        return _mithrilResolver.m('html', { config: config }, [_mithrilResolver.m('head', [_mithrilResolver.m('title', 'slide: ' + active()), _mithrilResolver.m('meta', { name: 'viewport', content: "width=device-width, initial-scale=1.0" }), _mithrilResolver.m('link', { href: './style.css', type: 'text/css', rel: 'stylesheet' })]), _mithrilResolver.m('body', [_mithrilResolver.m('.slides', _slide), arrows()])]);
    };
...
},{"mithril-resolver":193}],3:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/shim":188,"regenerator/runtime":189}],4:[function(require,module,exports){
...
},{"./$.to-index":76,"./$.to-length":79,"./$.to-object":80}],8:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./$.to-index":76,"./$.to-iobject":78,"./$.to-length":79}],9:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./$.ctx":18,"./$.iobject":35,"./$.is-array":37,"./$.is-object":39,"./$.to-length":79,"./$.to-object":80,"./$.wks":83}],10:[function(require,module,exports){
...
},{"./$":47,"./$.fails":25,"./$.iobject":35,"./$.to-object":80}],11:[function(require,module,exports){
...
},{"./$.cof":12,"./$.wks":83}],12:[function(require,module,exports){
...
},{"./$":47,"./$.core":17,"./$.ctx":18,"./$.defined":20,"./$.for-of":28,"./$.has":31,"./$.hide":32,"./$.is-object":39,"./$.iter-define":43,"./$.iter-step":45,"./$.mix":52,"./$.species":66,"./$.strict-new":67,"./$.support-desc":73,"./$.uid":81}],14:[function(require,module,exports){
...
},{"./$.an-object":5,"./$.array-methods":9,"./$.for-of":28,"./$.has":31,"./$.hide":32,"./$.is-object":39,"./$.mix":52,"./$.strict-new":67,"./$.uid":81}],16:[function(require,module,exports){
'use strict';
...
},{"./$.def":19,"./$.fails":25,"./$.for-of":28,"./$.global":30,"./$.iter-detect":44,"./$.mix":52,"./$.redef":59,"./$.strict-new":67,"./$.tag":74}],17:[function(require,module,exports){
...
},{"./$.wks":83}],25:[function(require,module,exports){
...
},{"./$.defined":20,"./$.fails":25,"./$.hide":32,"./$.redef":59,"./$.wks":83}],27:[function(require,module,exports){
'use strict';
...
},{"./$.an-object":5,"./$.ctx":18,"./$.is-array-iter":36,"./$.iter-call":41,"./$.to-length":79,"./core.get-iterator-method":84}],29:[function(require,module,exports){
...
},{"./$":47,"./$.to-iobject":78}],30:[function(require,module,exports){
...
},{"./$":47,"./$.property-desc":58,"./$.support-desc":73}],33:[function(require,module,exports){
...
},{"./$.iterators":46,"./$.wks":83}],37:[function(require,module,exports){
...
},{"./$.cof":12,"./$.is-object":39,"./$.wks":83}],41:[function(require,module,exports){
...
},{"./$":47,"./$.hide":32,"./$.property-desc":58,"./$.tag":74,"./$.wks":83}],43:[function(require,module,exports){
'use strict';
...
},{"./$":47,"./$.def":19,"./$.has":31,"./$.hide":32,"./$.iter-create":42,"./$.iterators":46,"./$.library":49,"./$.redef":59,"./$.tag":74,"./$.wks":83}],44:[function(require,module,exports){
...
},{"./$.wks":83}],45:[function(require,module,exports){
...
},{"./$":47,"./$.to-iobject":78}],49:[function(require,module,exports){
...
},{"./$.cof":12,"./$.global":30,"./$.task":75}],52:[function(require,module,exports){
...
},{"./$":47,"./$.to-iobject":78}],55:[function(require,module,exports){
...
},{"./$.core":17,"./$.global":30,"./$.hide":32,"./$.uid":81}],60:[function(require,module,exports){
...
},{"./$.a-function":4,"./$.an-object":5,"./$.wks":83}],66:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , SPECIES = require('./$.wks')('species');
...
},{"./$":47,"./$.support-desc":73,"./$.wks":83}],67:[function(require,module,exports){
...
},{"./$.defined":20,"./$.to-integer":77}],69:[function(require,module,exports){
...
},{"./$.defined":20,"./$.is-regexp":40}],70:[function(require,module,exports){
...
},{"./$.defined":20,"./$.string-repeat":71,"./$.to-length":79}],71:[function(require,module,exports){
'use strict';
var toInteger = require('./$.to-integer')
  , defined   = require('./$.defined');
...
},{"./$.defined":20,"./$.to-integer":77}],72:[function(require,module,exports){
// 1 -> String#trimLeft
// 2 -> String#trimRight
// 3 -> String#trim
...
},{"./$.def":19,"./$.defined":20,"./$.fails":25}],73:[function(require,module,exports){
// Thank's IE8 for his funny defineProperty
module.exports = !require('./$.fails')(function(){
  return Object.defineProperty({}, 'a', {get: function(){ return 7; }}).a != 7;
});
},{"./$.fails":25}],74:[function(require,module,exports){
...
},{"./$":47,"./$.has":31,"./$.wks":83}],75:[function(require,module,exports){
'use strict';
var ctx                = require('./$.ctx')
  , invoke             = require('./$.invoke')
  , html               = require('./$.html')
...
},{"./$.cof":12,"./$.ctx":18,"./$.dom-create":21,"./$.global":30,"./$.html":33,"./$.invoke":34}],76:[function(require,module,exports){
var toInteger = require('./$.to-integer')
  , max       = Math.max
  , min       = Math.min;
...
},{"./$.defined":20,"./$.iobject":35}],79:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./$.to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./$.defined":20}],81:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./$.hide":32,"./$.wks":83}],83:[function(require,module,exports){
...
},{"./$.global":30,"./$.shared":63,"./$.uid":81}],84:[function(require,module,exports){
...
},{"./$.classof":11,"./$.core":17,"./$.iterators":46,"./$.wks":83}],85:[function(require,module,exports){
'use strict';
var $                = require('./$')
  , SUPPORT_DESC     = require('./$.support-desc')
  , createDesc       = require('./$.property-desc')
...
},{"./$":47,"./$.a-function":4,"./$.an-object":5,"./$.array-includes":8,"./$.array-methods":9,"./$.cof":12,"./$.def":19,"./$.dom-create":21,"./$.fails":25,"./$.has":31,"./$.html":33,"./$.invoke":34,"./$.iobject":35,"./$.is-array":37,"./$.is-object":39,"./$.property-desc":58,"./$.support-desc":73,"./$.to-index":76,"./$.to-integer":77,"./$.to-iobject":78,"./$.to-length":79,"./$.to-object":80,"./$.uid":81}],86:[function(require,module,exports){
// 22.1.3.3 Array.prototype.copyWithin(target, start, end = this.length)
'use strict';
var $def = require('./$.def');
...
},{"./$.array-copy-within":6,"./$.def":19,"./$.unscope":82}],87:[function(require,module,exports){
// 22.1.3.6 Array.prototype.fill(value, start = 0, end = this.length)
var $def = require('./$.def');
...
},{"./$.array-fill":7,"./$.def":19,"./$.unscope":82}],88:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":9,"./$.def":19,"./$.unscope":82}],89:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":9,"./$.def":19,"./$.unscope":82}],90:[function(require,module,exports){
'use strict';
var ctx         = require('./$.ctx')
  , $def        = require('./$.def')
  , toObject    = require('./$.to-object')
...
},{"./$.ctx":18,"./$.def":19,"./$.is-array-iter":36,"./$.iter-call":41,"./$.iter-detect":44,"./$.to-length":79,"./$.to-object":80,"./core.get-iterator-method":84}],91:[function(require,module,exports){
'use strict';
...
setUnscope('values');
setUnscope('entries');
},{"./$.iter-define":43,"./$.iter-step":45,"./$.iterators":46,"./$.to-iobject":78,"./$.unscope":82}],92:[function(require,module,exports){
'use strict';
var $def = require('./$.def');
...
},{"./$.def":19,"./$.fails":25}],93:[function(require,module,exports){
require('./$.species')(Array);
},{"./$.species":66}],94:[function(require,module,exports){
'use strict';
var $             = require('./$')
  , isObject      = require('./$.is-object')
...
},{"./$":47,"./$.is-object":39,"./$.wks":83}],95:[function(require,module,exports){
...
},{"./$":47,"./$.has":31,"./$.property-desc":58,"./$.support-desc":73}],96:[function(require,module,exports){
'use strict';
...
},{"./$.collection":16,"./$.collection-strong":13}],97:[function(require,module,exports){
...
},{"./$.def":19,"./$.log1p":50}],98:[function(require,module,exports){
...
},{"./$.def":19,"./$.sign":64}],101:[function(require,module,exports){
...
},{"./$.def":19,"./$.expm1":23}],104:[function(require,module,exports){
...
},{"./$.def":19,"./$.sign":64}],105:[function(require,module,exports){
...
},{"./$.def":19,"./$.fails":25}],107:[function(require,module,exports){
...
},{"./$.def":19,"./$.log1p":50}],109:[function(require,module,exports){
...
},{"./$.def":19}],110:[function(require,module,exports){
// 20.2.2.28 Math.sign(x)
var $def = require('./$.def');

$def($def.S, 'Math', {sign: require('./$.sign')});
},{"./$.def":19,"./$.sign":64}],111:[function(require,module,exports){
...
},{"./$.def":19,"./$.expm1":23,"./$.fails":25}],112:[function(require,module,exports){
...
},{"./$.def":19,"./$.expm1":23}],113:[function(require,module,exports){
...
},{"./$":47,"./$.cof":12,"./$.fails":25,"./$.global":30,"./$.has":31,"./$.is-object":39,"./$.redef":59,"./$.support-desc":73}],115:[function(require,module,exports){
...
},{"./$.def":19,"./$.global":30}],117:[function(require,module,exports){
// 20.1.2.3 Number.isInteger(number)
var $def = require('./$.def');

$def($def.S, 'Number', {isInteger: require('./$.is-integer')});
},{"./$.def":19,"./$.is-integer":38}],118:[function(require,module,exports){
...
},{"./$.def":19,"./$.is-integer":38}],120:[function(require,module,exports){
...
},{"./$.def":19}],124:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');

$def($def.S + $def.F, 'Object', {assign: require('./$.assign')});
},{"./$.assign":10,"./$.def":19}],125:[function(require,module,exports){
...
},{"./$.is-object":39,"./$.object-sap":53}],126:[function(require,module,exports){
...
},{"./$.object-sap":53,"./$.to-iobject":78}],127:[function(require,module,exports){
// 19.1.2.7 Object.getOwnPropertyNames(O)
require('./$.object-sap')('getOwnPropertyNames', function(){
  return require('./$.get-names').get;
});
},{"./$.get-names":29,"./$.object-sap":53}],128:[function(require,module,exports){
...
},{"./$.object-sap":53,"./$.to-object":80}],129:[function(require,module,exports){
...
},{"./$.is-object":39,"./$.object-sap":53}],132:[function(require,module,exports){
// 19.1.3.10 Object.is(value1, value2)
var $def = require('./$.def');
$def($def.S, 'Object', {
  is: require('./$.same')
});
},{"./$.def":19,"./$.same":61}],133:[function(require,module,exports){
...
},{"./$.object-sap":53,"./$.to-object":80}],134:[function(require,module,exports){
...
},{"./$.is-object":39,"./$.object-sap":53}],136:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $def = require('./$.def');
$def($def.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.def":19,"./$.set-proto":62}],137:[function(require,module,exports){
'use strict';
...
},{"./$.classof":11,"./$.redef":59,"./$.wks":83}],138:[function(require,module,exports){
'use strict';
var $          = require('./$')
...
},{"./$":47,"./$.a-function":4,"./$.an-object":5,"./$.classof":11,"./$.core":17,"./$.ctx":18,"./$.def":19,"./$.for-of":28,"./$.global":30,"./$.is-object":39,"./$.iter-detect":44,"./$.library":49,"./$.microtask":51,"./$.mix":52,"./$.same":61,"./$.set-proto":62,"./$.species":66,"./$.species-constructor":65,"./$.strict-new":67,"./$.support-desc":73,"./$.tag":74,"./$.uid":81,"./$.wks":83}],139:[function(require,module,exports){
...
},{"./$.def":19}],140:[function(require,module,exports){
...
},{"./$":47,"./$.a-function":4,"./$.an-object":5,"./$.core":17,"./$.def":19,"./$.fails":25,"./$.is-object":39}],141:[function(require,module,exports){
...
},{"./$":47,"./$.an-object":5,"./$.def":19,"./$.fails":25}],142:[function(require,module,exports){
...
},{"./$":47,"./$.an-object":5,"./$.def":19}],143:[function(require,module,exports){
'use strict';
...
},{"./$.an-object":5,"./$.def":19,"./$.iter-create":42}],144:[function(require,module,exports){
...
},{"./$":47,"./$.an-object":5,"./$.def":19}],146:[function(require,module,exports){
...
},{"./$":47,"./$.an-object":5,"./$.def":19,"./$.has":31,"./$.is-object":39}],147:[function(require,module,exports){
...
},{"./$.def":19}],148:[function(require,module,exports){
...
},{"./$.an-object":5,"./$.def":19}],149:[function(require,module,exports){
// 26.1.11 Reflect.ownKeys(target)
var $def = require('./$.def');

$def($def.S, 'Reflect', {ownKeys: require('./$.own-keys')});
},{"./$.def":19,"./$.own-keys":55}],150:[function(require,module,exports){
...
},{"./$.an-object":5,"./$.def":19}],151:[function(require,module,exports){
...
},{"./$.def":19,"./$.set-proto":62}],152:[function(require,module,exports){
...
},{"./$":47,"./$.an-object":5,"./$.def":19,"./$.has":31,"./$.is-object":39,"./$.property-desc":58}],153:[function(require,module,exports){
var $        = require('./$')
  , global   = require('./$.global')
...
},{"./$":47,"./$.fails":25,"./$.flags":27,"./$.global":30,"./$.is-regexp":40,"./$.redef":59,"./$.species":66,"./$.support-desc":73,"./$.wks":83}],154:[function(require,module,exports){
// 21.2.5.3 get RegExp.prototype.flags()
var $ = require('./$');
...
},{"./$":47,"./$.flags":27,"./$.support-desc":73}],155:[function(require,module,exports){
// @@match logic
...
},{"./$.collection":16,"./$.collection-strong":13}],160:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":19,"./$.string-at":68}],161:[function(require,module,exports){
...
},{"./$.def":19,"./$.fails-is-regexp":24,"./$.string-context":69,"./$.to-length":79}],162:[function(require,module,exports){
var $def    = require('./$.def')
  , toIndex = require('./$.to-index')
...
},{"./$.def":19,"./$.to-index":76}],163:[function(require,module,exports){
...
},{"./$.def":19,"./$.fails-is-regexp":24,"./$.string-context":69}],164:[function(require,module,exports){
'use strict';
...
},{"./$.iter-define":43,"./$.string-at":68}],165:[function(require,module,exports){
var $def      = require('./$.def')
  , toIObject = require('./$.to-iobject')
  , toLength  = require('./$.to-length');
...
},{"./$.def":19,"./$.to-iobject":78,"./$.to-length":79}],166:[function(require,module,exports){
var $def = require('./$.def');
...
},{"./$.def":19,"./$.string-repeat":71}],167:[function(require,module,exports){
...
},{"./$.def":19,"./$.fails-is-regexp":24,"./$.string-context":69,"./$.to-length":79}],168:[function(require,module,exports){
'use strict';
...
},{"./$.string-trim":72}],169:[function(require,module,exports){
'use strict';
...
},{"./$":47,"./$.an-object":5,"./$.def":19,"./$.enum-keys":22,"./$.fails":25,"./$.get-names":29,"./$.global":30,"./$.has":31,"./$.is-array":37,"./$.keyof":48,"./$.library":49,"./$.property-desc":58,"./$.redef":59,"./$.shared":63,"./$.support-desc":73,"./$.tag":74,"./$.to-iobject":78,"./$.uid":81,"./$.wks":83}],170:[function(require,module,exports){
'use strict';
var $            = require('./$')
...
},{"./$":47,"./$.collection":16,"./$.collection-weak":15,"./$.has":31,"./$.is-object":39,"./$.redef":59}],171:[function(require,module,exports){
'use strict';
...
},{"./$.collection":16,"./$.collection-weak":15}],172:[function(require,module,exports){
'use strict';
var $def      = require('./$.def')
...
},{"./$.array-includes":8,"./$.def":19,"./$.unscope":82}],173:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
var $def  = require('./$.def');

$def($def.P, 'Map', {toJSON: require('./$.collection-to-json')('Map')});
},{"./$.collection-to-json":14,"./$.def":19}],174:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $def     = require('./$.def')
...
},{"./$.def":19,"./$.object-to-array":54}],175:[function(require,module,exports){
...
},{"./$":47,"./$.def":19,"./$.own-keys":55,"./$.property-desc":58,"./$.to-iobject":78}],176:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $def    = require('./$.def')
...
},{"./$.def":19,"./$.object-to-array":54}],177:[function(require,module,exports){
// https://github.com/benjamingr/RexExp.escape
var $def = require('./$.def')
  , $re  = require('./$.replacer')(/[\\^$*+?.()|[\]{}]/g, '\\$&');
$def($def.S, 'RegExp', {escape: function escape(it){ return $re(it); }});

},{"./$.def":19,"./$.replacer":60}],178:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
var $def  = require('./$.def');

$def($def.P, 'Set', {toJSON: require('./$.collection-to-json')('Set')});
},{"./$.collection-to-json":14,"./$.def":19}],179:[function(require,module,exports){
...
},{"./$.def":19,"./$.string-at":68}],180:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":19,"./$.string-pad":70}],181:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
  , $pad = require('./$.string-pad');
$def($def.P, 'String', {
...
},{"./$.def":19,"./$.string-pad":70}],182:[function(require,module,exports){
'use strict';
...
},{"./$.string-trim":72}],183:[function(require,module,exports){
'use strict';
// https://github.com/sebmarkbage/ecmascript-string-left-right-trim
...
},{"./$.string-trim":72}],184:[function(require,module,exports){
...
},{"./$":47,"./$.core":17,"./$.ctx":18,"./$.def":19}],185:[function(require,module,exports){
...
},{"./$.global":30,"./$.hide":32,"./$.iterators":46,"./$.wks":83,"./es6.array.iterator":91}],186:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":19,"./$.task":75}],187:[function(require,module,exports){
...
},{"./$.def":19,"./$.global":30,"./$.invoke":34,"./$.partial":56}],188:[function(require,module,exports){
require('./modules/es5');
...
},{"./lib/polyfill":3}],191:[function(require,module,exports){
